...
public class ContactCreationTest {
  ...
  public void testContactCreation() throws Exception {
    startAddingContact();
    fillContactData(new ContactData("Olga", "Novikova", "Novikova", "tester", "nickname", "company", "address", "23445435345", "6785634", "3475687", "567789789", "dfgdffg@sf.ru", "mail2@mail.ru", "mail3@mail.ru", "homepage.com"));
    submitContactData();
    logout();
  }
