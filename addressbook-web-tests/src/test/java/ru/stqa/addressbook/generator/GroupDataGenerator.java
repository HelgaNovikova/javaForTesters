...
public class GroupDataGenerator {
    ...
    @Parameter(names = "-f", description = "file with group data")
    public String file;
    ...
    private void saveGroupsAsCSV(List<GroupData> groups, File file) throws IOException {
        Writer writer = new FileWriter(file);
    ...
    private List<GroupData> generateGroups(int count) {
        ...
        for (int i = 0; i < count; i++) {
            groups.add(new GroupData().withName("generatedName" + i).withHeader("generatedHeader" + i)
                    .withFooter("generatedFooter" + i));
        }
        return groups;
    }
}
